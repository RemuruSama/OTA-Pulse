...
/**
 * Material 3 Typography using Google Fonts (Outfit for headings, Inter for body/labels).
 * Falls back to system sans-serif if fonts cannot be downloaded or offline.
 */
val OtaPulseTypography = Typography(
