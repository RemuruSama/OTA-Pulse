...
class Realme8i : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("RU", "RMX3151", "RMX3151NV37"),
        Triple("ID", "RMX3151", "RMX3151NV33"),
        Triple("IN", "RMX3151", "RMX3151NV1B"),
        Triple("EU", "RMX3151", "RMX3151NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=R8i",
