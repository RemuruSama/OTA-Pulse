...
class Realme10Pro : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3661", "RMX3661NV1A"),
        Triple("RU", "RMX3661", "RMX3661NV37"),
        Triple("MY", "RMX3661", "RMX3661NV38"),
        Triple("ID", "RMX3661", "RMX3661NV33"),
        Triple("TH", "RMX3661", "RMX3661NV39"),
        Triple("IN", "RMX3660", "RMX3660NV1B"),
        Triple("CN", "RMX3663", "RMX3663NV97")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=R10P",
