...
class OnePlus10TAcePro : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2413", "CPH2413NV1B"), //
        Triple("GLO", "CPH2415", "CPH2415NVA7"), //
        Triple("EU", "CPH2415EEA", "CPH2415NV44"), //
        Triple("CN", "PGP110", "PGP110NV97") //
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                name = "OnePlus 10T/Ace Pro", //
                ruiVersion = 5, // Use the latest ruiVersion
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OP10TAP", //
