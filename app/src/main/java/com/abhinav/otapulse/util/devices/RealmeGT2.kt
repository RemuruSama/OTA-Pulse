...
class RealmeGT2 : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3311", "RMX3311NV1A"), //
        Triple("TR", "RMX3311", "RMX3311NV51"), //
        Triple("RU", "RMX3311", "RMX3311NV37"), //
        Triple("MEA", "RMX3311", "RMX3311NVA6"), //
        Triple("MY", "RMX3311", "RMX3311NV38"), //
        Triple("SA", "RMX3311", "RMX3311NV83"), //
        Triple("ID", "RMX3311", "RMX3311NV33"), //
        Triple("EU", "RMX3311", "RMX3311NV44"), //
        Triple("TH", "RMX3311", "RMX3311NV39"), //
        Triple("LATAM", "RMX3311", "RMX3311NV9A"), //
        Triple("BR", "RMX3311", "RMX3311NV9E"), //
        Triple("IN", "RMX3312", "RMX3312NV1B"), //
        Triple("CN", "RMX3310", "RMX3310NV97") //
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=RGT2", //
