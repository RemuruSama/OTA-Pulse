...
class Realme12Plus_5G : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3867", "RMX3867NV1A"),
        Triple("TR", "RMX3867", "RMX3867NV51"),
        Triple("RU", "RMX3867", "RMX3867NV37"),
        Triple("MEA", "RMX3867", "RMX3867NVA6"),
        Triple("MY", "RMX3867", "RMX3867NV38"),
        Triple("SA", "RMX3867", "RMX3867NV83"),
        Triple("ID", "RMX3867", "RMX3867NV33"),
        Triple("IN", "RMX3867IN", "RMX3867NV1B"),
        Triple("EU", "RMX3867", "RMX3867NV44"),
        Triple("TH", "RMX3867", "RMX3867NV39"),
        Triple("LATAM", "RMX3867", "RMX3867NV9A"),
        Triple("BR", "RMX3867", "RMX3867NV9E"),
        Triple("CN", "RMX3867", "RMX3867NV97")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=12P_5G",
