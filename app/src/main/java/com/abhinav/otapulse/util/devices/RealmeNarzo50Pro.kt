...
class RealmeNarzo50Pro : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3396", "RMX3396NV1A"),
        Triple("IN", "RMX3395", "RMX3395NV1B")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=RN50P",
