...
class Realme8_5G : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3241", "RMX3241NV1A"),
        Triple("RU", "RMX3241", "RMX3241NV37"),
        Triple("MY", "RMX3241", "RMX3241NV38"),
        Triple("SA", "RMX3241", "RMX3241NV83"),
        Triple("ID", "RMX3241", "RMX3241NV33"),
        Triple("IN", "RMX3241", "RMX3241NV1B"),
        Triple("EU", "RMX3241", "RMX3241NV44"),
        Triple("TH", "RMX3241", "RMX3241NV39"),
        Triple("LATAM", "RMX3241", "RMX3241NV9A"),
        Triple("BR", "RMX3241", "RMX3241NV9E"),
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=R8_5G",
