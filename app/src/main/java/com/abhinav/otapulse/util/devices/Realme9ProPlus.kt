...
class Realme9ProPlus : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3393", "RMX3393NV1A"),
        Triple("TR", "RMX3393", "RMX3393NV51"),
        Triple("RU", "RMX3393", "RMX3393NV37"),
        Triple("MEA", "RMX3393", "RMX3393NVA6"),
        Triple("MY", "RMX3393", "RMX3393NV38"),
        Triple("SA", "RMX3393", "RMX3393NV83"),
        Triple("ID", "RMX3393", "RMX3393NV33"),
        Triple("EU", "RMX3393", "RMX3393NV44"),
        Triple("TH", "RMX3393", "RMX3393NV39"),
        Triple("LATAM", "RMX3393", "RMX3393NV9A"),
        Triple("BR", "RMX3393", "RMX3393NV9E"),
        Triple("IN", "RMX3392", "RMX3392NV1B")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=R9PP",
