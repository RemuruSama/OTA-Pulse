...
class RealmeNarzo30_5G : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("RU", "RMX3242", "RMX3242NV37"),
        Triple("IN", "RMX3242", "RMX3242NV1B"),
        Triple("EU", "RMX3242", "RMX3242NV44"),
        Triple("LATAM", "RMX3242", "RMX3242NV9A")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=RN30_5G",
