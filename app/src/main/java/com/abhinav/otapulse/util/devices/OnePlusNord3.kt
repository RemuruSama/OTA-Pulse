...
class OnePlusNord3 : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2491", "CPH2491NV1B"),
        Triple("GLO", "CPH2493", "CPH2493NVA7"),
        Triple("EU", "CPH2493EEA", "CPH2493NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OPN3",
