...
class OnePlusPadGo2_WiFi : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "OPD2504IN", "OPD2504NV1B"),
        Triple("GLO", "OPD2504", "OPD2504NVA7"),
        Triple("EU", "OPD2504EEA", "OPD2504NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                name = "OnePlus Pad Go 2 WiFi",
                ruiVersion = 5,
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OPPG2_WF",
