...
class OnePlusNordCE4Lite : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2619IN", "CPH2619NV1B"),
        Triple("GLO", "CPH2621", "CPH2621NVA7"),
        Triple("EU", "CPH2621EEA", "CPH2621NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OPNCE4L",
