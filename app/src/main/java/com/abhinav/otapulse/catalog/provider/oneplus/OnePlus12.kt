...
class OnePlus12 : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2573IN", "CPH2573NV1B"),
        Triple("GLO", "CPH2581", "CPH2581NVA7"),
        Triple("EU", "CPH2581EEA", "CPH2581NV44"),
        Triple("CN", "PJD110", "PJD110NV97")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OP12",
