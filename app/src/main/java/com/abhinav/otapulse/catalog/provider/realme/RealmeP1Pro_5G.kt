...
class RealmeP1Pro_5G : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("MEA", "RMX3844", "RMX3844NVA6"),
        Triple("IN", "RMX3844IN", "RMX3844NV1B"),
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=P1P_5G",
