...
class OnePlusPad3 : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "OPD2415IN", "OPD2415NV1B"),
        Triple("GLO", "OPD2415", "OPD2415NVA7"),
        Triple("EU", "OPD2415EEA", "OPD2415NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OPP3",
