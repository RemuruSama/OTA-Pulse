...
class RealmeNarzo50A : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("TW", "RMX3430", "RMX3430NV1A"),
        Triple("ID", "RMX3430", "RMX3430NV33"),
        Triple("IN", "RMX3430", "RMX3430NV1B"),
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=RN50A",
