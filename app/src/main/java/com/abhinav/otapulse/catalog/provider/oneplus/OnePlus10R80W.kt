...
class OnePlus10R80W : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2423", "CPH2423NV1B"), //
        Triple("CN", "PGKM10", "PGKM10NV97") //
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OP10R80W", //
