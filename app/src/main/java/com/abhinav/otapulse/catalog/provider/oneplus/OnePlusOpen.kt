...
class OnePlusOpen : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "CPH2551IN", "CPH2551NV1B"),
        Triple("EU", "CPH2551EEA", "CPH2551NV44")
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=OPOpen",
