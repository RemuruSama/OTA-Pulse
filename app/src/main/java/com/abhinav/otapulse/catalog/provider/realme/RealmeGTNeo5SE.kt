...
class RealmeGTNeo5SE : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("MEA", "RMX3701", "RMX3701NVA6"), //
        Triple("CN", "RMX3700", "RMX3700NV97") //
    )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=RGTN5SE", //
