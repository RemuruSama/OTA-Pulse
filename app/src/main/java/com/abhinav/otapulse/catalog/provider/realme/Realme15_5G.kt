...
class Realme15_5G : DeviceProvider {
    ...
    private val baseVariants = listOf(
        Triple("IN", "RMX5106IN", "RMX5106NV1B"),
        Triple("KZ", "RMX5106", "RMX5106NV5A"),
        Triple("CN", "RMX5105", "RMX5105NV97"),
        )
    ...
    override fun getDevices(): List<PredefinedDevice> {
        return listOf(
            PredefinedDevice(
                ...
                imageUrl = "https://placehold.co/100x100/E0F2F1/00796B?text=15_5G",
