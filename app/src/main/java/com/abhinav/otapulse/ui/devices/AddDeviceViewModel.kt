...
import com.abhinav.otapulse.util.RegionInfo
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (_uiState.value.isEditMode && _uiState.value.oldDeviceName != null) {
                    otaRepository.updateCustomDevice(_uiState.value.oldDeviceName!!, newDevice)
                } else {
                    otaRepository.addCustomDevice(newDevice)
                }
